...
export function VoiceView({
	...
	}, [streaming, autoEnabled, onSpeakText, playingTTS]);
	...
	return (
		<div
			className="flex-1 flex flex-col items-center justify-between gap-4 p-4 select-none"
			dir="rtl"
		>
			...
			<div className="w-full flex flex-col items-center gap-3 pt-2">
				...
				<div className="text-center">
					...
					<p className="text-xs text-muted-foreground mt-0.5">
						{isRecording
							? "تحدث الآن — اضغط مرة أخرى للإرسال"
							: busy
								? ""
