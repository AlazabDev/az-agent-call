...
export default function Accounts() {
  ...
  const [testBody, setTestBody] = useState("اختبار اتصال SMTP من لوحة Az Agent Call Center.");
    ...
    >
      <div className="space-y-6" dir="rtl">
        ...
        <Card className="shadow-card overflow-hidden">
          <CardHeader><CardTitle className="text-base">Mailbox Registry</CardTitle><CardDescription>المصدر الفعلي: `public.call_agents` + حالة الاتصال من `call_agent_connections`.</CardDescription></CardHeader>
