				...
				<Card className="shadow-card overflow-hidden">
					<CardHeader>
						<CardTitle className="text-base flex items-center gap-2">
							<UserCheck className="h-4 w-4 text-primary" /> قائمة العملاء
							المباشرة
						</CardTitle>
						<CardDescription>
							مصدر البيانات: Daftra ERP Live API Engine
						</CardDescription>
					</CardHeader>
							...
							<TableBody>
								...
								{clientsQuery.isError && (
									<TableRow>
										...
										>
											لم يتم تهيئة الربط المباشر مع Daftra ERP
									...
									return (
										<TableRow key={c.id}>
											...
											<TableCell className="font-mono font-bold text-xs">
												{c.unpaid || c.balance
													? `${(c.unpaid || c.balance || 0).toLocaleString()} EGP`
													: "0 EGP"}
											</TableCell>
											<TableCell>
												<Badge
