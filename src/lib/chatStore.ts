...
export const DEFAULT_FOUNDRY_CONFIG: FoundryConnectionConfig = {
	...
	mcpEndpoint: "https://mcp.alazab.com/call",
...
export function getAgentWelcomeMessage(agentId: AgentId): string {
	const welcomes: Record<AgentId, string> = {
		backend:
			"مرحباً بك! أنا وكيل البنية التحتية والخوادم (az-agent-backend). كيف يمكنني مساعدتك في صيانة الخدمات وبوابات API اليوم؟",
		azabot:
			"أهلاً بك! أنا عزبوت (az-agent-azabot) المساعد الذكي العام لنظام العزب. أنا جاهز لإجابة استفساراتك وتنفيذ مهام البريد وإرسال التنبيهات.",
		...
		maint:
			"مرحباً! أنا وكيل الصيانة والتشغيل (az-agent-maint). يمكنك تزويدي بطلبات الصيانة والمخططات للبدء فوراً.",
		...
		finance:
			"مرحباً! أنا وكيل المالية والمحاسبة (az-agent-finance). أتابع الفواتير وإشعارات المدفوعات والتقارير المالية.",
		payments:
			"أهلاً بك! أنا وكيل معالجة الدفع والتحصيلات (az-agent-payments). أساعدك في توثيق العمليات وإرسال إيصالات الاستلام.",
		copilot:
			"مرحباً بك! أنا الكوبايلوت المساعد البرمجي (az-agent-copilot). أستطيع مساعدتك في صياغة الأكواد البرمجية وتحليل الأخطاء.",
		project:
			"أهلاً بك! أنا وكيل إدارة المشاريع (az-agent-project). أتابع الجداول الزمنية والمهام وتحديثات سير العمل.",
		vision:
			"مرحباً! أنا وكيل الرؤية الحاسوبية والذكاء الاصطناعي (az-agent-vision). أحلل الصور والوثائق والمخططات الفنية المرفقة.",
	};
